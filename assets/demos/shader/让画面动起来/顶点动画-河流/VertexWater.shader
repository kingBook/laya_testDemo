Shader3D Start
{
    ...
    uniformMap:{
        u_Magnitude: {type:Float, default:1.0},
        u_Frequency: {type:Float, default:1.0},
        u_InvWaveLength: {type:Float, default:10.0},
...
#defineGLSL unlitVS
    ...
    void main()
    {
        ...
        offset.z = sin(u_Frequency * u_Time + vertex.positionOS.x * u_InvWaveLength) * u_Magnitude;
        // 

        vec4 pos = (worldMat * vec4(vertex.positionOS+offset, 1.0));
